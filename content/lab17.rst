...
алкановых спиртов gn. Напишите функции, которые вычисляют количество изомеров по этим формулам. Попробуйте fn для числа n = 167 - 
должно получиться число больше, чем количество элементарных частиц в нашей вселенной. Длинная арифметика Python позволяет посчитать его. 
