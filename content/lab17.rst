...
Очень удобно также то, что в Питон встроены даже комплексные числа. Они записываются с помощью символа j. Например, `2 + 1j`.
...
В Питоне целые числа зачастую удобнее вещественных и комплексных, потому что только они поддерживают встроенную в Питон длинную арифметику. Чтобы сохранить её преимущества для вещественных чисел, нередко используют те или иные модули, в которых реализованы, например, рациональные числа на основе целых чисел Питона и, таким образом, используются возможности длинной арифметики. 
...
Также к ним применимы особые функции для целых чисел.
...
Гораздо больше функций для работы с ними есть в модуле cmath, который используется в Питоне. 
