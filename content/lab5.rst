...
int atoi(str);  float atoi(str);  - преобразуют текстовые строки str в числа.
...
envp[] – это массив указателей на значения переменных окружения. С помощью него можно их вывести. Запустите код ниже.
