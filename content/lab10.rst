...
.. code-block:: cpp
  ...
  int main()
  {
    ...
    print_long(a); cout << ' + ';       // print:
    print_long(b); cout << ' = ';       // 
    print_long(c);                      // 7250 + 2868 = 10118
