...
При регистрации пожалуйста создайте логин в следующем формате: 0400X_Y_Z, где X - последняя цифра вашей группы, Y - фамилия на латинице, X - инициалы на латинице.
