...
Оптимизируйте алгоритм из упражнения 2, сохраняя текущее расстояние до каждой вершины в массиве, который обновлять при добавлении новой вершины. Так, чтобы по каждому ребру "проходить" один раз, а не при добавлении каждой вершины. 

Для тех, кто хочет покопаться углубленно:  решите задачу из упражнения №2, реализовав алгоритм Дейкстры за O((N+M) log N).
