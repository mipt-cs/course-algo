...
или программе может не хватить разрядности для принятия решения к какому диапазону отнести данное число. 
Для примера можно привести баг https://bugs.php.net/bug.php?id=53632 , который вызвал панику в 2011-м.
...
до бесконечности, а второй - быстро сходящийся. Допустим, если ряд знакопеременный, то ускорение будет происходить,
если перемножать на ряд (1+x2)^N. 
...
Формула Эйлера по двум точкам: 

Наиболее эффективным является метод Гаусса - Кронрода, который комбинирует оба способа: .
